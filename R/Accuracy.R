...
#' @param response (optional) A string (default \code{"discrete"}), data format. Can also be \code{"continuous"}. Can be abbreviated. If \code{"discrete"}, will apply an \code{\link[arg max]{Argmax}} before computing accuracy.
#' 
#' @details
